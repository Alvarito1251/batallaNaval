...
function checkShot(event) {
    ...
    if (matrixAttack[x][y] === "ship") {
        let acertaste = document.createElement("p");
        let divbutton = document.querySelector(".row");
        divbutton.appendChild(acertaste);
        acertaste.innerHTML = "Acertaste";
        acertaste.style.color = "red";
        acertaste.style.width = "15px";
        setTimeout(() => {
            divbutton.removeChild(acertaste);
        }, 2000);
        // function myFunction() {
        ...
        let fallaste = document.createElement("div");
        let divbutton = document.querySelector(".row");
        divbutton.appendChild(fallaste);
        fallaste.innerHTML = "Fallaste";
        fallaste.style.color = "blue";
        fallaste.style.width = "15px";
        setTimeout(() => {
            divbutton.removeChild(fallaste);
        }, 2000);
